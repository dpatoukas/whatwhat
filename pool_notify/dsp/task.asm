...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/184543cDFUv /tmp/18454n8eLpd 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$48	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$48, DW_AT_name("/data/home/in4342-06/assignment02/carlo/pool_notify/dsp/task.asm:$C$L3:1:1495460985")
...
$C$DW$50	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$50, DW_AT_name("/data/home/in4342-06/assignment02/carlo/pool_notify/dsp/task.asm:$C$L1:1:1495460985")
...
$C$DW$65	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$65, DW_AT_name("/data/home/in4342-06/assignment02/carlo/pool_notify/dsp/task.asm:$C$L9:1:1495460985")
...
$C$DW$67	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$67, DW_AT_name("/data/home/in4342-06/assignment02/carlo/pool_notify/dsp/task.asm:$C$L7:1:1495460985")
